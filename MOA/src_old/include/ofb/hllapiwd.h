/******************************************************************************
*
*   hllapiWD.h - RT definitions / declarations for the Wall Data HllApi
*
*     This file is a copy of the WALL DATA file "EEHLLAPI.H", with
*     modifications to allow it to be included in RT applications.
*     Since RT only allows for #define statements, the modifications
*     are simple - anything other than #define statements are excluded
*     using the statement '#if(0)'.
*
*******************************************************************************/
/******************************************************************************
*
...
#if (0)     /* ONA - Excluding the following code */
/*----------------------------------------------------------------------------*/
...
#endif                  /* End of ONA Excluded Code */
