# Microsoft Developer Studio Generated NMAKE File, Based on csr.dsp
!IF "$(CFG)" == ""
CFG=csr - Win32 Debug
!MESSAGE No configuration specified. Defaulting to csr - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "csr - Win32 Debug"
...
!MESSAGE 
!MESSAGE "csr - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\csr.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib version.lib imm32.lib /nologo /base:"0x12000000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\csr.pdb" /map:"..\bin\csr.map" /debug /debugtype:both /machine:I386 /nodefaultlib:"msvcrt.lib" /def:".\csr\csr.def" /out:"$(OUTDIR)\csr.dll" /implib:".\lib\csr.lib" 
DEF_FILE= \
	".\csr\csr.def"
LINK32_OBJS= \
	"$(INTDIR)\apl_inde.obj" \
...
CPP_PROJ=/nologo /MDd /W3 /GX /Z7 /Od /Gf /Gy /I ".\csr" /I ".\include" /I ".\include\ofb" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "NT" /D "LITTLE_ENDIAN" /D "DEBUGCODEWANTED" /Fp".\lib\pch.pch" /YX"pch.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\csr_v.res" /i ".\include" /d "_DEBUG" 

!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("csr.dep")
!INCLUDE "csr.dep"
!ELSE 
!MESSAGE Warning: cannot find "csr.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\csr_v.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\csr_v.res" /i "csr" /i ".\csr" /d "_DEBUG" $(SOURCE)
